...
***REMOVED***
***REMOVED*** This file is the source Rails uses to define your schema when running `rails
***REMOVED*** db:schema:load`. When creating a new database, `rails db:schema:load` tends to
***REMOVED*** be faster and is potentially less error prone than running all of your
***REMOVED*** migrations from scratch. Old migrations may fail to apply correctly if those
***REMOVED*** migrations use external dependencies or application code.
***REMOVED***
***REMOVED*** It's strongly recommended that you check this file into your version control system.

ActiveRecord::Schema.define(version: 2020_06_11_022148) do
